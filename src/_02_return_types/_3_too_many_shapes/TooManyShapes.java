...
public class TooManyShapes {
	...
	public static void main(String[] args) {
		...
		String sidesAsString = JOptionPane.showInputDialog("How much sides do you want your shape to be?");
		//2. Ask the user how many shapes they want
		String shapesAsString = JOptionPane.showInputDialog("How much shapes do you want");
		//3. Call canMakeShape() and save what is returned into a variable
		int shapes = Integer.parseInt(shapesAsString);
		int sides = Integer.parseInt(sidesAsString);
		canMakeShape(shapes);
		//4. If the shape CAN be drawn
		if(canMakeShape(shapes)) {
			calculateTurnAngle(sides);
			drawPolygons(sides,shapes,60);
		}
